...
public class Hyperlinks {
    ...
    public static final String LAUNCH_GUIDE =
            "https://github.com/crschnick/pdx_unlimiter/wiki/User-Guide#launching-savegames";
    public static final String SAVESCUM_GUIDE =
            "https://github.com/crschnick/pdx_unlimiter/wiki/User-Guide#savegame-checkpoints-and-savescumming";
