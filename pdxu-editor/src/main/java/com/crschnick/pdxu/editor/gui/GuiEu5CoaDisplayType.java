...
public abstract class GuiEu5CoaDisplayType extends GuiCoaDisplayType {

    public static GuiEu5CoaDisplayType NONE = new GuiEu5CoaDisplayType() {

        @Override
        public Image render(CoatOfArms coa, GameFileContext ctx) {
            return ImageHelper.toFXImage(Eu5TagRenderer.renderImage(coa, ctx, (int) (size.get() * 1.5), size.get()));
        }
    };

    public static void init(GuiCoaViewerState.Eu5GuiCoaViewerState state, HBox box) {
